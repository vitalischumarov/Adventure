...
struct StoryModel {
    ...
    mutating func updateNextQuestion(selected: Int){
        storyNumber = selected
        print(" new storyNumer is \(storyNumber)")
    }
    
    func checkGameStatus() -> Bool {
        print("nex destination is: \(stories[storyNumber].choice1Destination)")
